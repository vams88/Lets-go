...
function setAdminTab(tab){
  ...
  applications?.classList.toggle("hidden", showBookings);
  bookings?.classList.toggle("hidden", !showBookings);
  applicationsTab?.classList.toggle("active", !showBookings);
...
refreshBtn.addEventListener("click", () => {
  ...
  return bookingsVisible ? loadAdminBookings() : loadApplications();
});
